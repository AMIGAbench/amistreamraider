...
class TranscodeManager:
    ...
    def __init__(
        ...
        *,
        ...
        browser_exec = os.getenv("STREAMLINK_WEBBROWSER_EXECUTABLE", "").strip()
        if browser_exec and "--webbrowser-executable" not in self.streamlink_args:
            self.streamlink_args.extend(["--webbrowser-executable", browser_exec])
        browser_extra = os.getenv("STREAMLINK_WEBBROWSER_EXTRA_ARGS", "").strip()
        if browser_extra and "--webbrowser-extra-args" not in self.streamlink_args:
            self.streamlink_args.extend(["--webbrowser-extra-args", browser_extra])
